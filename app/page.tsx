...
export default function Home() {
  ...
  useEffect(() => {
    ...
    fetchMarketData();
    const interval = setInterval(fetchMarketData, 10000); // 10 Sec Auto Refresh
  ...
  // 2. NSE API फेच करणारा useEffect जोडा
  useEffect(() => {
    ...
    // दर १० सेकंदांनी Auto-Refresh करा
    const interval = setInterval(fetchNSEData, 10000);
    return () => clearInterval(interval);
  }, []);
